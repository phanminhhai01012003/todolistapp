...
class ProgressTask extends StatefulWidget {
  final bool isGrid;
  const ProgressTask({super.key, required this.isGrid});
...
class _ProgressTaskState extends State<ProgressTask> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: _todoService.getUserTask("Progress"), 
    ...
    return ListView.builder(
            ...
            itemBuilder: (context, index){
              ...
              return Container(
                ...
                child: ListTile(
                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => ProgressTaskDetail(todo: todo))),
